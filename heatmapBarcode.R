...
barcodes <- read_tsv("pan-loss/cancer_only-interaction-barcodes-10000.tsv")
...
inter_fracc <- lapply(tissues, function(tissue) {
  stats <- read_tsv(paste0(tissue, "/network_aracne/cancer-network-stats-10000.tsv")) %>%
...
png(paste0("pan-loss/cancer-only_heatmap_complete.png"), width = 300, height = 1000)
print(hd)
dev.off()
...
png(paste0("pan-loss/cancer-only_heatmap_up75.png"), width = 800, height = 1000)
